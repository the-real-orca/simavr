...
#ifndef __SIM_MEGA16_H__
#define __SIM_MEGA16_H__
...
/*
 * This is a template for atmega16
 */
struct mcu_t {
	avr_t          core;
	avr_eeprom_t 	eeprom;
...
const struct mcu_t SIM_CORENAME = {
	...
	.watchdog = {
		...
		.wdce = AVR_IO_REGBIT(WDTCR, WDTOE),
		.wde = AVR_IO_REGBIT(WDTCR, WDE),
		.wdp = { AVR_IO_REGBIT(WDTCR, WDP0),AVR_IO_REGBIT(WDTCR, WDP1),
				AVR_IO_REGBIT(WDTCR, WDP2) },
		.watchdog = {
			.enable = AVR_IO_REGBIT(WDTCR, 6),
			.raised = AVR_IO_REGBIT(WDTCR, 7),
			.vector = _VECTOR(0)
		},
	},
	.extint = {
	...
	.adc = {
		...
		.r_adcsrb = SFIOR,
		.adts = { AVR_IO_REGBIT(SFIOR, ADTS0), AVR_IO_REGBIT(SFIOR, ADTS1), AVR_IO_REGBIT(SFIOR, ADTS2),},
	...
	.timer2 = {
		...
		.cs_div = { 0, 0, 3 /* 8 */, 4 /* 32 */, 6 /* 64 */, 7 /* 128 */, 8 /* 256 */, 10 /* 1024 */ },
